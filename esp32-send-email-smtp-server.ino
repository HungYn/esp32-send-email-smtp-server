/*
   ...
   使用Arduino開發ESP32（19）：獲取網絡時間 https://bbs.huaweicloud.com/blogs/258089
   ESP32 NTP Client-Server https://randomnerdtutorials.com/esp32-date-time-ntp-client-server-arduino/
   介紹的是簡稱「MIME」的網際網路標準 https://zh.wikipedia.org/wiki/%E5%A4%9A%E7%94%A8%E9%80%94%E4%BA%92%E8%81%AF%E7%B6%B2%E9%83%B5%E4%BB%B6%E6%93%B4%E5%B1%95
*/
...
// Wifi Seting
char ssid[] = "liveXXX"; // edit this
char pass[] = "0938XXXX"; // edit this
WiFiClient client;
int status = WL_IDLE_STATUS;

// Email server setting
char server[] = "mail.XXXXX.com.tw";// edit this 郵件主機
int port = 25;
char myIP[] = "myIP"; // edit this 發送郵件電腦名稱
char username[] = "bGl2ZTUyMA=="; // edit this要轉換成base64 live520→bGl2ZTUyMA==
char password[] = "bGl2ZTUyMA=="; // edit this要轉換成base64 live520→bGl2ZTUyMA==
char sender[] = "<XXXX@XXXX.com.tw>"; // edit this 發件者
char reciver[] = "<XXXX@XXXX.com.tw>"; // edit this 收件者
char cc[] = "<XXXX@yahoo.com.tw>";// edit this 副本
char Subject[] = "電腦室溫度測試異常回報";// edit this 主旨
char timeStringBuff[50]; //日期時間設定50字符

//===========================================

const char* ntpServer = "time.nist.gov"; //NTP主機位址
const long  gmtOffset_sec = 28800; // 時區（以秒為單位） 8*60*60
